---
layout: post
title: Allowing only one instance of a WPF application to execute
published: 1
categories: [WPF]
comments: [disqus]
slug: "A built-in single-instance watcher using Semaphores."
alias: /bonus-bits/2010/10/allowing-only-one-instance-of-a-wpf-application-to-execute-at-any-given-time.html
---
<p>Sometimes, for any reason, you want to have only one instance per application.</p>
